...
def exec_bat_preset_localization():
...
if __name__ == "__main__":
	code_exec_choice = input("Choose an option below:\n\tEnter 1 for Bat Dataset (with pre-set Localization)\n\tEnter 2 for Bat Dataset (with self-generating localization)\n\tEnter 3 for Cell Dataset (with self-generating localization)\n")
	code_exec_h = {
		"1": exec_bat_preset_localization(),
		"2": exec_bat_self_gen_localization(),
		"3": exec_cell_self_gen_localization()
	}
